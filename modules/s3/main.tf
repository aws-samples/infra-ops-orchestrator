...
resource "aws_s3_bucket_public_access_block" "sample_kb_bucket" {
...
resource "aws_s3_bucket_public_access_block" "sample_kb_logging_bucket" {
...
resource "aws_s3_bucket_versioning" "sample_kb_logging_bucket" {
  bucket = aws_s3_bucket.sample_kb_logging_bucket.id
  versioning_configuration {
    status = "Enabled"
  }
